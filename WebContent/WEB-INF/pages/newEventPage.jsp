...
<body>
	...
	<form:form class="form form-horizontal" method="POST" action="newEvent"
		modelAttribute="event" style="margin-top: 20px; width: 500px">

		<table>
			<tr valign="bottom">
				<td style="font-size: 28px"><b>New Event</b></td>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<form:input type="datetime-local" class="form-control" path="start" id="start"
					placeholder="Enter a start date and time" required="required" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<form:input type="datetime-local" class="form-control" path="end" id="end"
					placeholder="Enter a end date and time" required="required" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<form:input path="location" class="form-control"
					placeholder="Enter a location" required="required" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<form:textarea path="description" class="form-control" rows="6"
					cols="44" placeholder="Enter a description" />
			</div>
		</div>
	</form:form>
